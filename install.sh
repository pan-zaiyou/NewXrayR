...
install_XrayR() {
    ...
    file="https://raw.githubusercontent.com/pan-zaiyou/NewXrayR/main/XrayR.service"
    ...
    if [[ ! -f /etc/XrayR/config.yml ]]; then
        wget -q -N --no-check-certificate -O /etc/XrayR/config.yml https://raw.githubusercontent.com/pan-zaiyou/NewXrayR/main/config.yml
        echo -e ""
    ...
    if [[ ! -f /etc/XrayR/dns.json ]]; then
        wget -q -N --no-check-certificate -O /etc/XrayR/dns.json https://raw.githubusercontent.com/pan-zaiyou/NewXrayR/main/dns.json
    fi
    if [[ ! -f /etc/XrayR/route.json ]]; then
        wget -q -N --no-check-certificate -O /etc/XrayR/route.json https://raw.githubusercontent.com/pan-zaiyou/NewXrayR/main/route.json
    fi
    if [[ ! -f /etc/XrayR/custom_outbound.json ]]; then
        wget -q -N --no-check-certificate -O /etc/XrayR/custom_outbound.json https://raw.githubusercontent.com/pan-zaiyou/NewXrayR/main/custom_outbound.json
    fi
    #if [[ ! -f /etc/XrayR/custom_inbound.json ]]; then
        #cp custom_inbound.json /etc/XrayR/
    #fi
    if [[ ! -f /etc/XrayR/rulelist ]]; then
        wget -q -N --no-check-certificate -O /etc/XrayR/rulelist https://raw.githubusercontent.com/pan-zaiyou/NewXrayR/main/rulelist
    fi
